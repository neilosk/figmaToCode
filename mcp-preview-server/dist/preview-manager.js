...
export class PreviewManager {
    previews = new Map();
    BASE_URL = 'http://localhost:3015/preview'; // MCP server preview endpoint
    /**
     * Generate a unique preview ID
     */
    generatePreviewId(componentName) {
     ...
     */
    storePreviewRequest(previewId, request) {
        this.previews.set(previewId, request);
    }
    /**
     * Get a preview request
     */
    getPreviewRequest(previewId) {
        return this.previews.get(previewId);
    }
    /**
     * Update preview status
     */
    updatePreviewStatus(previewId, status, error) {
     ...
     */
    reconstructCodeFromChunks(chunks) {
     ...
     */
    createHTMLTemplate(componentName, code, cssContent, styling) {
